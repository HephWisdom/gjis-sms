              ...
              return (
                ...
                >
                  <div className="flex justify-between">
                    <h2 className="font-semibold">{r.studentName}</h2>
                    <span className="text-sm text-gray-500">{r.className}</span>
                  </div>
                  <p className="text-gray-600 text-sm">{r.type} Fee</p>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
          <div className="bg-white p-6 rounded-2xl shadow-lg w-11/12 max-w-md">
            <h2 className="text-lg font-bold mb-4 text-gray-800">
              Edit {editingRecord.type} Payment <br />
